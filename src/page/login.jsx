...
//                 <form className="flex flex-col justify-center gap-3 rounded-lg text-black p-4 w-80 shadow-[0_0_10px_black]">
...
//                     <div className="flex flex-col gap-1">
//                         <label htmlFor="text" className="font-semibold">OTP</label>
//                         <input
//                             type="text"
//                             name="text"
//                             id="text"
