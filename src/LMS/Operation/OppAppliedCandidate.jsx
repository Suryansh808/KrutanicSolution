...
const OppAppliedCandidate = () => {
  // Sample data for demonstration (aap isko API se fetch karke ya props ke through bhej sakte hain)
  const candidateData = [
            ...
            {candidateData.map((candidate) => (
              <tr key={candidate.id} className="text-center">
                ...
                <td className="py-2 px-4 border-b">
                  <button className="bg-green-500 text-white px-3 py-1 mr-2 rounded hover:bg-green-600">
                    Accept
                  </button>
...
export default OppAppliedCandidate;
